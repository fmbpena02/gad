...
<html lang="en">
	...
	<body id="body-pd">
		<header class="header" id="header">
			...
			<!------- DATE SELECTOR -------->
			<div
				class="dateSelector_attendance d-flex flex-row align-items-center justify-content-evenly m-2 p-2 rounded-3">
				<div class="d-flex justify-content-center align-items-center">
					<label for="selectedYear">Year:</label>
					<select name="selectedYear" id="selectedYear" class="form-select">
				...
				<div class="d-flex justify-content-center align-items-center">
					...
					<select
						...
						<option value="January">Januaryjvjh</option>
				...
				<div
					class="checkBox-container d-flex flex-row flex-nowrap align-items-center">
					<input
						class="me-2"
						type="checkbox"
					...
					<label class="text-nowrap" for="isOnlyMonths_attendance">
						Attendance/Month
					</label>
				</div>
			</div>
		...
		<div class="l-navbar" id="nav-bar">
			<nav class="nav">
				<div>
					...
					<div class="nav_list">
						<a href="index.html" class="nav_link active" id="attendance">
							<i class="bx bx-grid-alt nav_icon"></i>
							<span class="nav_name">Attendance</span>
						</a>
						<a href="./assets/pages/gender.html" class="nav_link" id="gender">
							<i class="bx bx-user nav_icon"></i>
							<span class="nav_name">Gender</span>
						</a>
						<a href="./assets/pages/events.html" class="nav_link" id="events">
							<i class="bx bx-message-square-detail nav_icon"></i>
							<span class="nav_name">Events</span>
						</a>
						<a href="./assets/pages/logs.html" class="nav_link" id="logs">
				...
				<div class="outline row">
					...
					<section class="outline main-chart-section col-lg-8">
						<aside class="outline row pb-3">
							<!------ CHART NAME ------>
							<div class="outline col-lg-4" id="card-chart-name">
								<div class="card-wrapper card shadow-sm text-center">
									<div
										class="card-body card-info-height align-items-center justify-content-center d-flex flex-column">
										<h5 class="card-title bold m-0">ATTENDANCE</h5>
									</div>
								</div>
							</div>

							<!------ TOTAL ------>
							<aside class="SideTotal col-lg-4 outline">
								<div class="card-wrapper card shadow-sm text-center">
									<div class="card-body card-info-height">
										<h6 class="card-subtitle mb-2 text-body-secondary">
											TOTAL
										</h6>
										<h5 class="card-title m-0">1234</h5>
									</div>
								</div>
							</aside>

							<!------ CHART DATE ------>
							<div class="outline col-lg-4" id="card-date">
								<div class="card-wrapper card shadow-sm text-center">
									<div
										...
										<div class="d-flex flex-row gap-2 gap-lg-4">
											<h5 class="card-title card-year m-0" id="card-year">
												2023
											</h5>
											<h5 class="card-title card-month m-0" id="card-month">
												-
											</h5>
										</div>
									</div>
						...
						<div class="outline container-fluid p-0 m-0">
							<div class="main-chart-wrapper card shadow rounded-3">
					...
					<section
						...
						<!----- YEARLY CHART ------->
						<div class="outline container-fluid p-0 m-0">
							<div class="yearly-chart-wrapper card shadow rounded-3">
								<canvas class="" id="yearly-chart"></canvas>
							</div>
						</div>

						<!-------- QUARTERLY --------->
						<div class="outline side-quarterly container-fluid p-0 m-0">
							<div
								class="side-chart-wrapper card shadow rounded-3 px-lg-5 p-lg-3">
		...
		<script type="module" src="./assets/jquery/jquery-3.7.1.min.js"></script>
		<script
			type="module"
			src="./assets/datatable/jquery.dataTables.min.js"></script>
		...
		<script type="module" src="dateSelector.js"></script>
